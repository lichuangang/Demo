...
(function($) {
    ...
    var methods = {
        ...
        'highlight_range_cls': function (rangeMin, rangeMax, cls) {
            //console.log(cls)
            var $this = this;
            var settings = $this.data('settings');
            ...
            // set position
            var $highlightPanel = $this.find(cls);
        ...
        'highlight_range_html': function (cls) {
            //console.log(cls)
            var $this = this;
            var settings = $this.data('settings');
            ...
            // avoid empty string
            var rangeMin = $highlightPanel.data("min");//为了配合故意前端显示+1
            var rangeMax = $highlightPanel.data("max");
